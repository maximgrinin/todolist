...
urlpatterns = [
    ...
    path('goal_category/<int:pk>', views.GoalCategoryView.as_view(), name='retrieve-update-destroy-category'),
    # Goals
    path('goal/create', views.GoalCreateView.as_view(), name='create-goal'),
    path('goal/list', views.GoalListView.as_view(), name='list-goals'),
    path('goal/<int:pk>', views.GoalView.as_view(), name='retrieve-update-destroy-goal'),
    # Goals comments
    ...
    path('goal_comment/<int:pk>', views.GoalCommentView.as_view(), name='retrieve-update-destroy-comment'),
]
